namespace Simple.Units
{
    ...
    public static class Units
    {
        ...
        public static Unit Celsuis = new Unit("Celsuis", "°C", new LazyUnits(() => new Dictionary<Unit, Func<double, double>>
        {
            { Fahrenheit, value =>(value * 9d / 5d) + 32 },
            { Kelvin, value => value + 273.15 }
        }));

        public static Unit Fahrenheit = new Unit("Fahrenheit", "°F", new LazyUnits(() => new Dictionary<Unit, Func<double, double>>
        {
            { Celsuis, value => ((value - 32) * 5) / 9d },
            { Kelvin, value => (((value - 32) * 5) / 9d) + 273.15 }
        }));

        public static Unit Kelvin = new Unit("Kelvin", "°K", new LazyUnits(() => new Dictionary<Unit, Func<double, double>>
        {
            { Celsuis, value => value - 273.15 },
            { Fahrenheit, value => ((value - 273.15) * 9d / 5d) + 32 }
        }));

        public static Unit Centimetre = new Unit("Centimetre", "cm", new LazyUnits(() => new Dictionary<Unit, Func<double, double>>
        {
        ...
        public static Unit Metre = new Unit("Metre", "m", new LazyUnits(() => new Dictionary<Unit, Func<double, double>>
        {
        ...
        public static Unit Kilometre = new Unit("Kilometre", "km", new LazyUnits(() => new Dictionary<Unit, Func<double, double>>
        {
            { Metre, value => value * 1000d },
            { Mile, value => value / 1.609344d },
        }));

        public static Unit Mile = new Unit("Mile", "mi", new LazyUnits(() => new Dictionary<Unit, Func<double, double>>
        {
        ...
        public static Unit Yard = new Unit("Yard", "yd", new LazyUnits(() => new Dictionary<Unit, Func<double, double>>
        {
        ...
        public static Unit Foot = new Unit("Foot", "ft", new LazyUnits(() => new Dictionary<Unit, Func<double, double>>
        {
        ...
        public static Unit Inch = new Unit("Inch", "in", new LazyUnits(() => new Dictionary<Unit, Func<double, double>>
        {
